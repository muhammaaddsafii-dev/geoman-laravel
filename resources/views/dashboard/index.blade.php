...
@push('scripts')
    ...
    <script>
        ...
        map.on('pm:create', function(e) {
            var layer = e.layer;
            var shapeType = e.shape; // 'Marker', 'Line', 'Rectangle', 'Polygon', 'Circle', ''
        ...
        //         // set value geometry to input geom
            ...
            //     $("#geom_polygon").val(objectGeometry);
            //     $("#PolygonModal").modal('show');
            // } else if (shapeType === 'Marker' || shapeType === 'Point') {
            //     $("#geom_point").val(objectGeometry);
            //     $("#PointModal").modal('show');
            // } else {
            //     console.log('_undefined_ shapeType:', shapeType);
            // }

            // drawnItems.addLayer(layer); // simpan layer ke FeatureGroup
        });
